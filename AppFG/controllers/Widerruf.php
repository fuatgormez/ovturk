...
class Widerruf extends CI_Controller {
...
//        $data['page_about'] = $this->Model_common->all_page_about();
        ...
        $data['page_widerruf'] = $this->Model_common->all_page_widerruf();
        ...
        {
            $this->load->view('layout/'.$data['setting']['layout'].'/view_widerruf',$data);
        } else {
