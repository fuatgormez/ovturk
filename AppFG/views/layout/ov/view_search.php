<!--==============================
    Breadcumb
============================== -->
<div class="breadcumb-wrapper breadcumb-layout1 background-image " data-vs-img="<?php echo base_url(); ?>public/uploads/<?php echo $setting['banner_search']; ?>" data-overlay="primary3" data-opacity="7">
    <div class="container">
        <div class="breadcumb-content py-100 py-lg-140">
            <h1 class="breadcumb-title title1 text-white mb-0"><?php echo $page_search['search_heading']; ?> <?php echo $search_string; ?></h1>
...
<section class="vs-service-wrapper service-box-layout1  pb-30 pb-lg-100 pt-60 pt-lg-130">
    <div class="container">
        <div class="row">
            <?php if(!$total): ?>
                <div class="alert alert-danger"><?php echo $this->lang->line('no_result_found'); ?></div>
            <?php else: ?>
