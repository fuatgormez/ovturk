                ...
                <div class="col-xl-6">
                    <div class="row no-gutters counter-box-layout1 justify-content-around bg-primary2 pr-30 pl-30 pr-xl-80 pl-xl-80 py-60 py-xl-80">
                        ...
                        <?php if(base_url() === 'https://irispicture.ch/'):?>
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                <h4 class="title text-center mt-0">Standorte in der Schweiz</h4>
                                <h5 class="title text-center mt-0">Zürich | Basel | Bern | St.Gallen | Schwyz | Bad Ragaz | Wettingen | Belb | Volketswil | Affoltern am Albis | Kreuzlingen | Feuerthalen | Urtenen-Schönbühl</h5>
                            </div>
                        <?php endif;?>
                    </div>
                </div>
