                        ...
                        <div class="vs-contact-widget">
                            ...
                            <div class="row">
                                <div class="col-lg-4 border-right">
                                    <p class="text"><i class="far fa-map-marker-alt"></i><?php echo nl2br($setting['footer_address']); ?></p>
                                </div>
                                <div class="col-lg-4 border-right">
                                    ...
                                    <p class="text"><i class="fal fa-phone-alt"></i>Erreiche uns unter: <span class="text-primary2 font-blod d-block"><?php echo nl2br($setting['footer_phone']); ?></span></p>
                                </div>
                                <div class="col-lg-4">
