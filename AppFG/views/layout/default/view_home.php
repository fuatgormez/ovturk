            ...
            <div class="col-lg-6 mt_30">
                <div class="about-content">
                    <div class="headline-left">
                        <h1><span><?php echo $page_home['home_welcome_title']; ?></span></h1>
                        <h3> <?php echo $page_home['home_welcome_subtitle']; ?></h3>
                    </div>
                    <p>
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div class="download-video">
                                            <div style="position:relative;height:0;padding-bottom:56.21%" class="embed-responsive">
                                                <iframe frameborder="0" scrolling="no" marginheight="0" src="https://www.youtube.com/embed/<?php echo $page_home['home_welcome_video']; ?>"></iframe>
                                            </div>
                                        </div>
                                    </div>
...
<div class="choose-area pt_60 pb_90" style="background-image: url(<?php echo base_url(); ?>public/uploads/<?php echo $page_home['home_why_choose_photo']; ?>)">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="headline">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="services-item effect-item">
                        ...
                        <div class="services-text">
                            <h3><a href="<?php echo base_url(); ?>service/<?php echo $row['id']; ?>/<?php echo $row['slug']; ?>"><?php echo $row['name']; ?></a></a></h3>
                            <p>
                        ...
                        <div class="blog-item effect-item">
                            ...
                            <div class="blog-author">
                                <ul>
                                    ...
                                    <li class="blog-button"><a href="<?php echo base_url(); ?>news/view/<?php echo $news['news_id']; ?>"><i class="fas fa-long-arrow-alt-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <?php
