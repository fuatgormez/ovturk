...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/uploads/<?php echo $setting['favicon']; ?>">

    <!-- Stylesheets -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/css/animate.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/css/jquery-ui.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/css/magnific-popup.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/css/meanmenu.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/css/style.css?v=1.0">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/css/spacing.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/css/responsive.css?v=1.0">
...
<body>
    ...
    <!--Preloader Start-->
    <div id="preloader">
        <div id="status" style="background-image: url(<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/images/preloader.svg)"></div>
    </div>
    <!--Preloader End-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12">
                    <div class="logo flex">
                        <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/uploads/<?php echo $setting['logo']; ?>" alt="Logo"></a>
                    </div>
                </div>
                        ...
                        <ul class="nav-menu">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?php echo base_url().'service/'.$row_service['id']; ?>/<?php echo $row_service['slug'];?>"><?php echo $row_service['name'];?></a></li>
                                    <?php endforeach;?>
                                </ul>
                                <?php endif;?>
                            </li>
