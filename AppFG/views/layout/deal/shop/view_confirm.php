        ...
        <div class="tab-content" id="productDetailsTab">
            <div class="tab-pane show active" id="review" aria-labelledby="review-tab">
                <div class="vs-comment-form comments-form-layout1 pt-30 mb-30">
                    <h4 class="inner-title mb-lg-40 text-danger">Hallo <?php echo $order->billing_firstname; ?>,</h4>
                    <h4 class="inner-title mb-lg-40">Danke für deinen Einkauf bei Irispicture.</h4>
                    <h4 class="inner-title mb-lg-40">Heute haben wir für Dich eine tolle Aktion am Start.Verpasse nicht DIE GELEGENHEIT.</h4>
                    <h4 class="inner-title mb-lg-40">Jetzt kannst Du Dein Produkt zu einmaligen Sonderpreisen upgraden.</h4>
                    <h3 class="inner-title mb-lg-40">Dazu brauchst nur auf dein bestelltes Produkt zu klicken und Dein Upgrade auszuwählen. </h3>
