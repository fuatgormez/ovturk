    ...
    <section>
        <div class="container">
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-8 col-xl-8 offsets-2">
                    <input type="text" class="store_search" id="searchCity" placeholder="search" value="">
                    <div class="store-list invisible">
...
============================== -->
    <?php if (!$this->input->cookie('required_cookie')) : ?>
        ...
        <?php echo form_open(base_url('cookie/ed8b172ad0e4433f9868511b6c91a76726702082'), array('class' => 'contact-form input-style3')); ?>
        <div id="cookie__agreement__wrapper">
            ...
            <div id="cookie__agreement__details">
                ...
                <div class="cookie--section">
                    <h2>
                        <input type="checkbox" name="required_cookie" id="required_cookie" disabled checked><label for="required_cookie">Notwendige Cookies</label>
                    </h2>
                    <p>
                    </p>
                ...
                <div class="cookie--section">
                    <h2>
                        <input type="checkbox" name="google_analytics_term" id="google_analytics_term" <?php echo $this->input->cookie('google_analytics_term') ? 'checked' : '' ?>><label for="google_analytics_term">Google Cookies</label>
                    </h2>
                    <p>
                    </p>
                ...
                <div class="cookie--section">
                    <h2>
                        <input type="checkbox" name="facebook_tracking_term" id="facebook_tracking_term" <?php echo $this->input->cookie('facebook_tracking_term') ? 'checked' : '' ?>><label for="facebook_tracking_term">Facebook Cookies</label>
                    </h2>
                    <p>
                    </p>
                ...
                <div class="cookie--section">
                    <h2>
                        <input type="checkbox" name="affiliate_marketing_term" id="affiliate_marketing_term" <?php echo $this->input->cookie('affiliate_marketing_term') ? 'checked' : '' ?>><label for="affiliate_marketing_term">Affiliate Marketing Cookies</label>
                    </h2>
                    <p>
                    </p>
                ...
                <div class="cookie--section">
                    <h2>
                        <input type="checkbox" name="youtube_term" id="youtube_term" <?php echo $this->input->cookie('youtube_term') ? 'checked' : '' ?>><label for="youtube_term">Youtube Cookies</label>
                        <p>
                        </p>
...
============================== -->
    ...
    <!-- Mobile Menu -->
    <!-- Main Js File -->
    <script src="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/js/shop.js"></script>
