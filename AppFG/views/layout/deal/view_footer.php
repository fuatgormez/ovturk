    ...
    <div class="container">
        ...
        <div class="footer-middle">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="widget widget-about">
                        <div class="widget-body">
                            <p class="ls-normal mb-4"><?php echo nl2br($setting['footer_address']); ?></p>
                        </div>
                    </div>
                    <!-- End Widget -->
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="widget">
                        <p class="text"><i class="fa fa-envelope"></i> <a href="mailto:<?php echo nl2br($setting['footer_email']); ?>"><?php echo nl2br($setting['footer_email']); ?></a>
                        </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget widget-info">
                        <h4 class="widget-title">Besuche uns auch auf Social Media:</h4>
                        <div class="social-links">
                            <?php foreach ($social as $row) : ?>
                                <?php if ($row['social_url'] != '') : ?>
                                    <a href="<?php echo $row['social_url']; ?>" class="social-link <?php echo $row['social_icon']; ?>"></a>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-center mb-0">
                <p class="copyright"><?php echo $this->lang->line('footer_copyright'); ?> | <?php echo $setting['footer_copyright']; ?></p>
            </div>
...
<script src="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/vendor/parallax/parallax.min.js"></script>
<script src="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
<script src="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/vendor/elevatezoom/jquery.elevatezoom.min.js"></script>
<script src="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/vendor/skrollr/skrollr.min.js"></script>
...
<script src="<?php echo base_url(); ?>public/layout/<?php echo $theme; ?>/vendor/jquery.count-to/jquery-numerator.min.js"></script>
<!-- sweetalert -->
