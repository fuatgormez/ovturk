<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>backend/admin/blog" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().'backend/admin/blog/edit/'.$blog['id'],array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="name" value="<?php echo $blog['name']; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Short Content *</label>
							<div class="col-sm-8">
								<textarea class="form-control" name="short_content" style="height:100px;"><?php echo $blog['short_content']; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Content *</label>
							<div class="col-sm-8">
								<textarea class="form-control" name="content" id="editor1"><?php echo $blog['content']; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="category_id" class="form-control select2">
									...
									foreach ($all_photo_category as $row) {
										?>
										<option value="<?php echo $row['category_id']; ?>" <?php if($row['category_id'] == $blog['category_id']) {echo 'selected';} ?>><?php echo $row['category_name']; ?></option>
										<?php
									}
									?>	
								</select>
						...
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px">
								<a href="<?php echo base_url('public/uploads/blog_photos/'.$blog['photo']); ?>" target="_blank">
									<img src="<?php echo base_url(); ?>public/uploads/blog_photos/<?php echo $blog['photo']; ?>" alt="" style="width:120px;">
								</a>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10" style="padding-top:5px">
								<table class="table table-bordered">
									<?php foreach ($all_photos_by_id as $row): ?>
										<tr>
											<td>
												<a href="<?php echo base_url('public/uploads/blog_photos/'.$row['photo']); ?>" target="_blank">
													<img src="<?php echo base_url('public/uploads/blog_photos/'.$row['photo']); ?>" alt="" style="width:120px;">
												</a>
											...
											<td>
												...
												<a href="<?php echo base_url(); ?>backend/admin/blog/single-photo-delete/<?php echo $row['id']; ?>/<?php echo $blog['id']; ?>" class="btn btn-danger btn-xl" onClick="return confirm('Are you sure?');">Delete</a>
											</td>
										</tr>
									<?php endforeach; ?>
								</table>								
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="meta_title" value="<?php echo $blog['meta_title']; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Meta Keyword</label>
							<div class="col-sm-8">
								<textarea class="form-control" name="meta_keyword" style="height:100px;"><?php echo $blog['meta_keyword']; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Meta Description</label>
							<div class="col-sm-8">
								<textarea class="form-control" name="meta_description" style="height:100px;"><?php echo $blog['meta_description']; ?></textarea>
							</div>
						</div>
						<!-- Blog Tag -->
							...
							<div class="col-sm-10">
								<select name="tag[]" class="form-control select2" multiple="multiple">
									<?php foreach ($tags as $tagKey => $tag) : ?>
										<?php if(in_array($tag['tag_id'], json_decode($blog['tag']))): ?>
