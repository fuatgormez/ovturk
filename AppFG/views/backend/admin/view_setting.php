            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_head">
                        <?php echo form_open(base_url() . 'backend/admin/setting/update', array('class' => 'form-horizontal', 'name' => 'form_head')); ?>
                        <h3 class="sec_title" style="margin-top:0px;"> Head </h3>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Head Tags ... </label>
                            <div class="col-sm-6">
                                <textarea class="form-control" name="head" style="height:470px;"><?php echo $setting['head']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label"></label>
